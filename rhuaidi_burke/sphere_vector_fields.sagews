...
︠ca19793b-bb63-4f1e-9567-54e6f44fabb2s︠
n = 4
...
for i in range(1, 2*n):
    v = vector(itertools.chain.from_iterable([[-X[2*j+1], X[2*j]] for j in range(n)]))
    V += [v]
...
show(A)
A.det()
︡6446e175-6be1-47cd-964c-388eec8c2a99︡{"html":"<div align='center'>$\\displaystyle \\left(\\begin{array}{rrrrrrrr}\nx_{1} &amp; x_{2} &amp; x_{3} &amp; x_{4} &amp; x_{5} &amp; x_{6} &amp; x_{7} &amp; x_{8} \\\\\n-x_{2} &amp; x_{1} &amp; -x_{4} &amp; x_{3} &amp; -x_{6} &amp; x_{5} &amp; -x_{8} &amp; x_{7} \\\\\n-x_{2} &amp; x_{1} &amp; -x_{4} &amp; x_{3} &amp; -x_{6} &amp; x_{5} &amp; -x_{8} &amp; x_{7} \\\\\n-x_{2} &amp; x_{1} &amp; -x_{4} &amp; x_{3} &amp; -x_{6} &amp; x_{5} &amp; -x_{8} &amp; x_{7} \\\\\n-x_{2} &amp; x_{1} &amp; -x_{4} &amp; x_{3} &amp; -x_{6} &amp; x_{5} &amp; -x_{8} &amp; x_{7} \\\\\n-x_{2} &amp; x_{1} &amp; -x_{4} &amp; x_{3} &amp; -x_{6} &amp; x_{5} &amp; -x_{8} &amp; x_{7} \\\\\n-x_{2} &amp; x_{1} &amp; -x_{4} &amp; x_{3} &amp; -x_{6} &amp; x_{5} &amp; -x_{8} &amp; x_{7} \\\\\n-x_{2} &amp; x_{1} &amp; -x_{4} &amp; x_{3} &amp; -x_{6} &amp; x_{5} &amp; -x_{8} &amp; x_{7}\n\\end{array}\\right)$</div>"}︡{"stdout":"0"}︡{"stdout":"\n"}︡{"done":true}︡
